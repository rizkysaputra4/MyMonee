...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let homeImageSelected = UIImage(named: "home_active")?.withRenderingMode(.alwaysTemplate)
...
//        homeTab.tabBarItem.setTitleTextAttributes([NSAttributedString.Key.foregroundColor: UIColor.lightGray], for: .normal)
        ...
        let impianImage = UIImage(named: "heart")?.withRenderingMode(.alwaysTemplate)
        let impianImageSelected = UIImage(named: "heart_active")?.withRenderingMode(.alwaysTemplate)
        ...
        let profileImageSelected = UIImage(named: "profile_active")?.withRenderingMode(.alwaysTemplate)
